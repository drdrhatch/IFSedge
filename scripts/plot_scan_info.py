...
def get_grids(data_in):
    ...
    kxc_array[:,:] = -1.0
    fill_index = np.empty(len(ky_array))
    fill_index[:] = -1
    for i in range(numscan_tot):
...
if 'x_local' in pars and not pars['x_local']:
    ...
    for i in range(len(data[:,0])):
       if modes[i] == 'MTM':
           ...
           mark = '+'
           col = 'green'
       plt.plot(data[i,0],data[i,12],color=col,marker=mark,markeredgewidth=2,markersize=5)
      
    plt.plot(ky_array,ky_array/ky_array-1.0,'-',color='black')
    plt.plot(ky_array,ky_array/ky_array*gamma_HB_x0,'-',color='red',label=r'$\gamma_{HB}$' + ' local')
    f.close()
    plt.xlabel(r'$k_y \rho_s$',size=18)
    ...
    for i in range(len(data[:,0])):
       if modes[i] == 'MTM':
           ...
           col = 'green'
       if data[i,4] > 0.0:
           plt.plot(data[i,0],data[i,4]/data[i,12],color=col,marker=mark,markeredgewidth=2,markersize=5)
      
    plt.plot(ky_array,ky_array/ky_array*0.4,'-',color='black')
    plt.plot(ky_array,ky_array/ky_array-1.0,'-',color='black')
    f.close()
    plt.xlabel(r'$k_y \rho_s$',size=18)
    plt.ylabel(r'$\gamma  / < \gamma_{HB} >$',size=18)
    plt.show()
    ...
    for i in range(len(data[:,0])):
       if modes[i] == 'MTM':
           ...
           col = 'green'
       if data[i,4] > 0.0:
           plt.plot(data[i,0],data[i,4]/(data[i,12]*ghbpa/gamma_HB_x0),color=col,marker=mark,markeredgewidth=2,markersize=5)
    ...
    for i in range(len(data[:,0])):
       if modes[i] == 'MTM':
           ...
           col = 'green'
       if data[i,4] > 0.0:
           plt.plot(data[i,0],data[i,4]/(data[i,13]*ghbpa/gamma_HB_x0),color=col,marker=mark,markeredgewidth=2,markersize=5)
    ...
    for i in range(len(data[:,0])):
       if modes[i] == 'MTM':
           ...
           col = 'green'
       if data[i,4] > 0.0:
           plt.plot(data[i,0],data[i,4]/(data[i,13]),color=col,marker=mark,markeredgewidth=2,markersize=5)
